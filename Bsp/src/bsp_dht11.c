...
void static Dht11_Read_TempHumidity_Handler(DHT11_Data_TypeDef * pdth11)
{
    ...
    if(read_flag == 0){
       // gctl_t.dht11_temp_value,  gctl_t.dht11_humidity_value
		   
		 gctl_t.dht11_humidity_value    = pdth11->humi_high8bit;
		   
		  gctl_t.dht11_temp_value  =  pdth11->temp_high8bit;//run_t.gDht11_temperature = (pdth11->temp_high8bit);
